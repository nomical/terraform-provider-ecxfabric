...
const (
	L2ConnectionStatusProvisioned    = "PROVISIONED"
	L2ConnectionStatusProvisioning   = "PROVISIONING"
	L2ConnectionStatusDeprovisioning = "DEPROVISIONING"
	L2ConnectionStatusDeprovisioned  = "DEPROVISIONED"
)
